...
python /shares/baxter/users/rdhakal/repos/metablify/preprocessing_toolchain/Metablify_preprocessor_toolchains/compress_tabular_data.py --config /shares/baxter/users/rdhakal/workscritps/florida.yaml
